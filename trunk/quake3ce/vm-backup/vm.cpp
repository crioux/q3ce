...
============
*/
int QDECL VM_DllSyscall(int a0,int a1, int a2, int a3,int a4, int a5,int a6,int a7,int a8,int a9,int a10,int a11,int a12,int a13)
{
  return currentVM->systemCall(a0,a1,a2,a3,a4,a5,a6,a7,a8,a9,a10,a11,a12,a13);
}
...
vm_t *VM_Restart( vm_t *vm ) {
	...
	if ( vm->dllHandle ) {
		char	name[MAX_QPATH];
		int			(*systemCall)(int a0,int a1, int a2, int a3,int a4, int a5,int a6,int a7,int a8,int a9,int a10,int a11,int a12,int a13);
...
vm_t *VM_Create( const char *module,
				int	(*systemCalls)(int a0,int a1, int a2, int a3,int a4, int a5,int a6,int a7,int a8,int a9,int a10,int a11,int a12,int a13),
				vmInterpret_t interpret ) 
{
	...
	if ( interpret == VMI_NATIVE ) {
		if ( DFIXED_NOT_ZERO(Cvar_VariableValue( "fs_restrict" ))) {
...
int	QDECL VM_Call_Routine( vm_t *vm, int callnum, int a1,int a2,int a3,int a4,int a5,int a6,int a7,int a8,int a9,int  a10,int  a11, int a12, int a13) 
{
	vm_t	*oldVM;
	int		r;
	...
	if ( vm->entryPoint ) 
	{
		r = vm->entryPoint( callnum, a1,a2,a3,a4,a5,a6,a7,a8,a9,a10,a11,a12, a13);
/* else if ( vm->compiled ) {
...
void VM_VmProfile_f( void ) {
	...
	sorted[0] = vm->symbols;
	total = DFIXED_FROM_INT(sorted[0]->profileCount);
	for ( i = 1 ; i < vm->numSymbols ; i++ ) {
		sorted[i] = sorted[i-1]->next;
		total += DFIXED_FROM_INT(sorted[i]->profileCount);
	}
	...
	for ( i = 0 ; i < vm->numSymbols ; i++ ) {
		...
		perc = FIXED_TO_INT( FIXED(100,0) * FIXED_FROM_INT(sym->profileCount) / FIXED_FROM_DFIXED(total) );
