...
void Reset_MenuEvent(void* ptr, int event) {
	...
	UI_NewGame();
	_UI_trap_Cvar_SetValue( "ui_spSelection", LFIXED_0 );
	UI_PopMenu();
	UI_SPLevelMenu();
}
...
static void Reset_MenuDraw( void ) {
	UI_DrawNamedPic( GFIXED(142,0), GFIXED(118,0), GFIXED(359,0), GFIXED(256,0), ART_FRAME );
