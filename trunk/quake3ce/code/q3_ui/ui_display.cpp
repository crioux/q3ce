...
static void UI_DisplayOptionsMenu_Event( void* ptr, int event ) {
	...
	case ID_BRIGHTNESS:
		_UI_trap_Cvar_SetValue( "r_gamma", MAKE_LFIXED(displayOptionsInfo.brightness.curvalue / GFIXED(10,0)) );
		break;
	
	case ID_SCREENSIZE:
		_UI_trap_Cvar_SetValue( "cg_viewsize", MAKE_LFIXED(displayOptionsInfo.screensize.curvalue * GFIXED(10 ,0)));
		break;
...
static void UI_DisplayOptionsMenu_Init( void ) {
	...
	displayOptionsInfo.banner.string			= strdup("SYSTEM SETUP");
	...
	displayOptionsInfo.graphics.string				= strdup("GRAPHICS");
	...
	displayOptionsInfo.display.string				= strdup("DISPLAY");
	...
	displayOptionsInfo.sound.string					= strdup("SOUND");
	...
	displayOptionsInfo.network.string				= strdup("NETWORK");
	...
	displayOptionsInfo.brightness.minvalue			= GFIXED(5,0);
	displayOptionsInfo.brightness.maxvalue			= GFIXED(20,0);
	...
	displayOptionsInfo.screensize.minvalue			= GFIXED(3,0);
    displayOptionsInfo.screensize.maxvalue			= GFIXED(10,0);
	...
	displayOptionsInfo.brightness.curvalue  = MAKE_GFIXED(_UI_trap_Cvar_VariableValue("r_gamma")) * GFIXED(10,0);
	displayOptionsInfo.screensize.curvalue  = MAKE_GFIXED(_UI_trap_Cvar_VariableValue( "cg_viewsize")) / GFIXED(10,0);
}
