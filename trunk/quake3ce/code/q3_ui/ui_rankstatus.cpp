...
static vec4_t s_rankingstatus_color_prompt  = {GFIXED(1,00), GFIXED(0,43), GFIXED(0,00), GFIXED(1,00)};
...
void RankStatus_Cache( void ) {
	_UI_trap_R_RegisterShaderNoMip( RANKSTATUS_FRAME );
}
...
void UI_RankStatusMenu( void ) {
	...
	s_status = (grank_status_t)_UI_trap_Cvar_VariableValue("client_status");
