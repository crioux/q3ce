...
static void UI_CreditMenu_Draw( void ) {
	...
	y += FIXED_TO_INT(GFIXED(1,42) * GFIXED(PROP_HEIGHT,0) * PROP_SMALL_SIZE_SCALE);
	UI_DrawProportionalString( 320, y, "Programming", UI_CENTER|UI_SMALLFONT, color_white );
	y += FIXED_TO_INT(GFIXED(PROP_HEIGHT,0) * PROP_SMALL_SIZE_SCALE);
	...
	y += FIXED_TO_INT(GFIXED(1,35) * GFIXED(PROP_HEIGHT,0) * PROP_SMALL_SIZE_SCALE);
