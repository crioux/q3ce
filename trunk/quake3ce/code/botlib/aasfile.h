...
#define TRAVEL_DOUBLEJUMP			15		//lfixed jump
...
typedef bvec3_t aas_vertex_t;

//just a plane in the third dimension
typedef struct aas_plane_s
{
	avec3_t normal;						//normal vector of the plane
	bfixed dist;							//distance of the plane (normal vector * distance = point in plane)
	int type;
} aas_plane_t;
...
typedef struct aas_area_s
{
	...
	bvec3_t mins;						//mins of the area
	bvec3_t maxs;						//maxs of the area
	bvec3_t center;						//'center' of the area
} aas_area_t;
