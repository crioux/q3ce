...
{"hspread", WEAPON_OFS(hspread), FT_FIXED},					//horizontal spread of projectiles (degrees from middle)
{"vspread", WEAPON_OFS(vspread), FT_FIXED},					//vertical spread of projectiles (degrees from middle)
{"speed", WEAPON_OFS(speed), FT_FIXED},						//speed of the projectile (0 = instant hit)
{"acceleration", WEAPON_OFS(acceleration), FT_FIXED},		//"acceleration" * time (in seconds) + "speed" = projectile speed
{"recoil", WEAPON_OFS(recoil), FT_FIXED|FT_ARRAY|FT_IS_BFIXED, 3},		//amount of recoil the player gets from the weapon
{"offset", WEAPON_OFS(offset), FT_FIXED|FT_ARRAY|FT_IS_BFIXED, 3},		//projectile start offset relative to eye and view angles
{"angleoffset", WEAPON_OFS(angleoffset), FT_FIXED|FT_ARRAY|FT_IS_AFIXED, 3},//offset of the shoot angles relative to the view angles
{"extrazvelocity", WEAPON_OFS(extrazvelocity), FT_FIXED},//extra z velocity the projectile gets
...
{"activate", WEAPON_OFS(activate), FT_FIXED},				//time it takes to select the weapon
{"reload", WEAPON_OFS(reload), FT_FIXED},						//time it takes to reload the weapon
{"spinup", WEAPON_OFS(spinup), FT_FIXED},						//time it takes before first shot
{"spindown", WEAPON_OFS(spindown), FT_FIXED},				//time it takes before weapon stops firing
{NULL, 0, 0, 0}
};
...
{"gravity", PROJECTILE_OFS(gravity), FT_FIXED|FT_IS_BFIXED},				//amount of gravity applied to the projectile [0,1]
{"damage", PROJECTILE_OFS(damage), FT_INT},					//damage of the projectile
{"radius", PROJECTILE_OFS(radius), FT_FIXED|FT_IS_BFIXED},				//radius of damage
...
{"push", PROJECTILE_OFS(push), FT_FIXED},						//amount a player is pushed away from the projectile impact
{"detonation", PROJECTILE_OFS(detonation), FT_FIXED},		//time before projectile explodes after fire pressed
{"bounce", PROJECTILE_OFS(bounce), FT_FIXED},				//amount the projectile bounces
{"bouncefric", PROJECTILE_OFS(bouncefric), FT_FIXED}, 	//amount the bounce decreases per bounce
{"bouncestop", PROJECTILE_OFS(bouncestop), FT_FIXED},		//minimum bounce value before bouncing stops
...
weaponconfig_t *LoadWeaponConfig(char *filename)
{
	...
	max_weaponinfo = FIXED_TO_INT(LibVarValue("max_weaponinfo", "32"));
	if (max_weaponinfo < 0)
	{
	...
	max_projectileinfo = FIXED_TO_INT(LibVarValue("max_projectileinfo", "32"));
