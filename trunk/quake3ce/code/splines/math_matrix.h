...
public:
	idVec3_t			mat[ 3 ];
					...
					mat3_t();
					mat3_t( gfixed src[ 3 ][ 3 ] );
					mat3_t( idVec3_t const &x, idVec3_t const &y, idVec3_t const &z );
					mat3_t( const gfixed xx, const gfixed xy, const gfixed xz, const gfixed yx, const gfixed yy, const gfixed yz, const gfixed zx, const gfixed zy, const gfixed zz );
	...
	mat3_t			operator*( gfixed a ) const;
	mat3_t			operator+( mat3_t const &a ) const;
	mat3_t			operator-( mat3_t const &a ) const;

	friend idVec3_t	operator*( const idVec3_t &vec, const mat3_t &mat );
	friend mat3_t	operator*( gfixed a, mat3_t const &b );

	mat3_t			&operator*=( gfixed a );
...
ID_INLINE mat3_t::mat3_t( gfixed src[ 3 ][ 3 ] ) {
...
ID_INLINE mat3_t::mat3_t( const gfixed xx, const gfixed xy, const gfixed xz, const gfixed yx, const gfixed yy, const gfixed yz, const gfixed zx, const gfixed zy, const gfixed zz ) {
...
ID_INLINE mat3_t mat3_t::operator*( gfixed a ) const {
	return mat3_t( 
...
ID_INLINE mat3_t operator*( gfixed a, mat3_t const &b ) {
	return mat3_t( 
...
ID_INLINE mat3_t &mat3_t::operator*=( gfixed a ) {
	mat[0].x *= a; mat[0].y *= a; mat[0].z *= a;
	mat[1].x *= a; mat[1].y *= a; mat[1].z *= a; 
	mat[2].x *= a; mat[2].y *= a; mat[2].z *= a;
...
ID_INLINE void mat3_t::Identity( void ) {
	mat[ 0 ].x = GFIXED_1; mat[ 0 ].y = GFIXED_0; mat[ 0 ].z = GFIXED_0;
	mat[ 1 ].x = GFIXED_0; mat[ 1 ].y = GFIXED_1; mat[ 1 ].z = GFIXED_0;
	mat[ 2 ].x = GFIXED_0; mat[ 2 ].y = GFIXED_0; mat[ 2 ].z = GFIXED_1;
}
...
ID_INLINE mat3_t SkewSymmetric( idVec3_t const &src ) {
	return mat3_t( GFIXED_0, -src.z,  src.y, src.z,   GFIXED_0, -src.x, -src.y,  src.x,   GFIXED_0 );
}
