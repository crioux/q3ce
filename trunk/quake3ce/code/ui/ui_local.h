...
#define UI_FONT_THRESHOLD		GFIXED(0,1)
...
extern gfixed		UI_ClampCvar( gfixed min, gfixed max, gfixed value );
extern void			UI_DrawNamedPic( gfixed x, gfixed y, gfixed width, gfixed height, const char *picname );
extern void			UI_DrawHandlePic( gfixed x, gfixed y, gfixed w, gfixed h, qhandle_t hShader ); 
extern void			UI_FillRect( gfixed x, gfixed y, gfixed width, gfixed height, const gfixed *color );
extern void			UI_DrawRect( gfixed x, gfixed y, gfixed width, gfixed height, const gfixed *color );
extern void     UI_DrawTopBottom(gfixed x, gfixed y, gfixed w, gfixed h);
extern void     UI_DrawSides(gfixed x, gfixed y, gfixed w, gfixed h);
extern void			UI_UpdateScreen( void );
extern void			UI_SetColor( const gfixed *rgba );
extern void			UI_LerpColor(vec4_t a, vec4_t b, vec4_t c, gfixed t);
extern void			UI_DrawBannerString( int x, int y, const char* str, int style, vec4_t color );
extern gfixed		UI_ProportionalSizeScale( int style );
extern void			UI_DrawProportionalString( int x, int y, const char* str, int style, vec4_t color );
extern int			UI_ProportionalStringWidth( const char* str );
extern void			UI_DrawString( int x, int y, const char* str, int style, vec4_t color );
extern void			UI_DrawChar( int x, int y, int ch, int style, vec4_t color );
extern qboolean 	UI_CursorInRect (int x, int y, int width, int height);
extern void			UI_AdjustFrom640( gfixed *x, gfixed *y, gfixed *w, gfixed *h );
...
void			_UI_trap_Cvar_Register( vmCvar_t *vmCvar, const char *varName, const char *defaultValue, int flags );
void			_UI_trap_Cvar_Update( vmCvar_t *vmCvar );
...
void			_UI_trap_Cmd_ExecuteText( int exec_when, const char *text );	// don't use EXEC_NOW!
...
int				_UI_trap_FS_Seek( fileHandle_t f, long offset, int origin ); // fsOrigin_t
...
void			_UI_trap_R_RegisterFont(const char *pFontname, int pointSize, fontInfo_t *font);
