 ...
 *
 * $Id: platform.h 206 2005-03-19 15:03:03Z picard $
 *
...
#define PLATFORM_LOWMEMORY		0x26
...
DLL void GetDebugPath(tchar_t* Path, const tchar_t* FileName);
DLL void GetSystemPath(tchar_t* Path, const tchar_t* FileName);
DLL bool_t SaveDocument(const tchar_t* Name, const char* Text,tchar_t* URL);

DLL void WaitDisable(bool_t);
DLL bool_t WaitBegin();
DLL void WaitEnd();

DLL void* BrushCreate(uint32_t);
