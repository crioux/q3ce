...
@*
@* $Id: idct_arm.s 131 2004-12-04 20:36:04Z picard $
@*
...
.global IDCT_Block4x8
.global IDCT_Block8x8
.global IDCT_Block4x8Swap
.global IDCT_Block8x8Swap

@ r6 Block
@ r7,r8 must be saved

.macro	MCol8 Name,Rotate,Pitch
...
&Name.Mode3:						@x0,x1,x2,x3,x4,x5,x6,x7
	...
	mov     r9, #0x8E, 28  
	orr     r9, r9, #4			@W1_minus_W7
	mla     r3, r9, r3, r11		@x4 = x8 + (W1_minus_W7) * x4

	mvn     r9, #0xD40
	eor     r9, r9, #0xD		@minus_W1_minus_W7
	mla     r12, r9, r12, r11	@x5 = x8 + (minus_W1_minus_W7) * x5
	...
	mvn     r9, #0x310
	eor     r9, r9, #0xE		@W5_minus_W3
	mla     r0, r9, r0, r11		@x6 = x8 + (W5_minus_W3) * x6

	mvn     r9, #0xFB0			@minus_W3_minus_W5
	mla     r5, r9, r5, r11		@x7 = x8 + minus_W3_minus_W5 * x7
	...
	mvn     r9, #0xEC0
	eor     r9, r9, #0x7		@minus_W2_minus_W6
	mla     r2, r9, r2, r4		@x2 = x1 + minus_W2_minus_W6 * x2

	mov     r9, #0x620			@W2_minus_W6
	mla     r1, r9, r1, r4		@x3 = x1 + (W2_minus_W6) * x3
...
CarryMask:	.DC.L 0x80808080
W1:			.DC.W	2841                 @ 2048*sqrt(2)*cos(1*pi/16) 
W3:			.DC.W 2408                 @ 2048*sqrt(2)*cos(3*pi/16) 
minus_W5:	.DC.W 0xF9B7 @-1609        @ 2048*sqrt(2)*cos(5*pi/16) 
W6:			.DC.W 1108                 @ 2048*sqrt(2)*cos(6*pi/16) 
W7:			.DC.W 565                  @ 2048*sqrt(2)*cos(7*pi/16) 
W2:			.DC.W 2676                 @ 2048*sqrt(2)*cos(2*pi/16) 
...
Row4_NoConst:
	...
	ldrsh	r10, W6
	mla     r5, r11, r5, r2		@x7 = x7 * minus_W5 + 4
	ldrsh	r11, W2
...
_W3:			.DC.W 2408                 @ 2048*sqrt(2)*cos(3*pi/16) 
_W6:			.DC.W 1108                 @ 2048*sqrt(2)*cos(6*pi/16) 
_W7:			.DC.W 565                  @ 2048*sqrt(2)*cos(7*pi/16) 

W1_minus_W7:		.DC.W 2276
minus_W1_minus_W7:	.DC.W 0xF2B2 @-3406
W5_minus_W3:		.DC.W 0xFCE1 @-799
minus_W2_minus_W6:	.DC.W 0xF138 @-3784
...
Row8_NoConst:
	...
	ldrsh	r12, W1_minus_W7
	add		r11,r3,r1			
	mul		r11,r10,r11			@x8 = W7 * (x4 + x5)
	ldrsh	r10, minus_W1_minus_W7
	mla     r3, r12, r3, r11	@x4 = x8 + W1_minus_W7 * x4
	ldrsh	r12, _W3
	mla     r1, r10, r1, r11	@x5 = x8 + minus_W1_minus_W7 * x5
	ldrsh	r10, W5_minus_W3	
	add		r11,r2,r5			@x6 + x7
	mul		r11,r12,r11			@x8 = W3 * (x6 + x7)
	mvn     r12, #0xFB0			@minus_W3_minus_W5
	mla		r2,r10,r2,r11		@x6 = x8 + W5_minus_W3 * x6
	ldrsh	r10, _W6
	mla		r5,r12,r5,r11		@x7 = x8 + minus_W3_minus_W5 * x7
	ldrsh	r12, minus_W2_minus_W6 
	add		r11, r0, r9, lsl #11@x8 = x0 + (x1 << 11)
	sub		r0, r0, r9, lsl #11	@x0 = x0 - (x1 << 11)
	add		r9, r4, r14
	mul		r9, r10, r9			@x1 = W6 * (x3 + x2)
	mov     r10, #0x620			@W2_minus_W6
	mla		r14, r12, r14, r9	@x2 = x1 + minus_W2_minus_W6 * x2
	mov		r12, #181
	mla		r4, r10, r4, r9		@x3 = x1 + W2_minus_W6 * x3
