 ...
 *
 * $Id: idct.h 206 2005-03-19 15:03:03Z picard $
 *
...
//---------------------------------------------------------------
// input format for Data and MCompData functions
#define IDCTFORMAT_BLOCK	1
#define IDCTFORMAT_PACK		2
...
#define IDCT_BLOCK_PREPARE(x,out)					\
	out = (idct_block_t*)ALIGN16(x->_block);		
...
DLL int CodecIDCTSetFormat(codecidct* p, int Flags, int Width, int Height, int IDCTWidth, int IDCTHeight);
