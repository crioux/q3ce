...
void PVRShell::SetEventHandler(PVREventHandler *pkh) 
{ 
	m_pShellInit->SetEventHandler(pkh); 
}

PVREventHandler *PVRShell::GetEventHandler() 
{ 
	return m_pShellInit->GetEventHandler();
}
