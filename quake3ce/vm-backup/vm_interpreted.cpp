...
static char	*opnames[256] = {
    ...
    #endif
#else
	#define	loadWord(addr) ( ((int)(((char *)addr)[0])) | (((int)((char *)addr)[1])<<8) | (((int)((char *)addr)[2])<<16) | (((int)((char *)addr)[3])<<24) )
#endif
...
//					VM_StackTrace( vm, programCounter, programStack );
		...
		*/
		...
		case OP_EQF:
			if ( ((fixed *)opStack)[-1] == *(fixed *)opStack ) {
				programCounter = r2;	//vm->instructionPointers[r2];
				opStack -= 2;
				goto nextInstruction;
			} else {
		...
		case OP_NEGF:
			*(fixed *)opStack =  -*(fixed *)opStack;
			goto nextInstruction;
		case OP_ADDF:
			*(fixed *)(opStack-1) = *(fixed *)(opStack-1) + *(fixed *)opStack;
			opStack--;
			goto nextInstruction;
		case OP_SUBF:
			*(fixed *)(opStack-1) = *(fixed *)(opStack-1) - *(fixed *)opStack;
