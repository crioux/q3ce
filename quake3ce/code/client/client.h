...
void	SCR_FillRect( gfixed x, gfixed y, gfixed width, gfixed height, 
					 const gfixed *color );
...
void	SCR_DrawBigString( int x, int y, const char *s, gfixed alpha );			// draws a string with embedded color control characters with fade
