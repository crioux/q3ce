...
#define ON_EPSILON		BFIXED(0,005)
...
// Changes Globals:		-
//===========================================================================
bsp_trace_t AAS_Trace(bvec3_t start, bvec3_t mins, bvec3_t maxs, bvec3_t end, int passent, int contentmask)
{
...
qboolean AAS_EntityCollision(int entnum,
					bvec3_t start, bvec3_t boxmins, bvec3_t boxmaxs, bvec3_t end,
...
// Changes Globals:		-
//===========================================================================
bsp_link_t *AAS_BSPLinkEntity(bvec3_t absmins, bvec3_t absmaxs, int entnum, int modelnum)
{
	return NULL;
...
int AAS_VectorForBSPEpairKey(int ent, const char *key, bvec3_t v)
{
	...
	//scanf into doubles, then assign, so it is bvec_t size independent
	v1 = v2 = v3 = 0.0;
...
// Changes Globals:		-
//===========================================================================
int AAS_BSPTraceLight(bvec3_t start, bvec3_t end, bvec3_t endpos, int *red, int *green, int *blue)
{
	return 0;
