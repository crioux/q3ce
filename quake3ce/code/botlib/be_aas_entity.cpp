...
// Changes Globals:		-
//===========================================================================
void AAS_EntityOrigin(int entnum, bvec3_t origin)
{
	if (entnum < 0 || entnum >= aasworld.maxentities)
	{
...
// Changes Globals:		-
//===========================================================================
int AAS_OriginOfMoverWithModelNum(int modelnum, bvec3_t origin)
{
	int i;
	aas_entity_t *ent;
...
// Changes Globals:		-
//===========================================================================
void AAS_EntitySize(int entnum, bvec3_t mins, bvec3_t maxs)
{
	aas_entity_t *ent;
...
// Changes Globals:		-
//===========================================================================
int AAS_NearestEntity(bvec3_t origin, int modelindex)
{
	int i, bestentnum;
	...
	bestentnum = 0;
	bestdist = BFIXED(99999,0);
	for (i = 0; i < aasworld.maxentities; i++)
	{
		ent = &aasworld.entities[i];
		if (ent->i.modelindex != modelindex) continue;
		VectorSubtract(ent->i.origin, origin, dir);
		if (abs(FIXED_TO_INT(dir[0])) < 40)
		{
			if (abs(FIXED_TO_INT(dir[1])) < 40)
			{
