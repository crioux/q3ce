...
void QDECL Log_WriteTimeStamped(char *fmt, ...)
{
	...
	fprintf(logfile.fp, "%d   %02d:%02d:%02d:%02d   ",
					logfile.numwrites,
					FIXED_TO_INT(botlibglobals.time / GFIXED(3600,0)),
					FIXED_TO_INT(botlibglobals.time / GFIXED(60,0)),
					FIXED_TO_INT(botlibglobals.time),
					(FIXED_TO_INT(botlibglobals.time * GFIXED(100,0))) - (FIXED_TO_INT(botlibglobals.time) * 100));
	va_start(ap, fmt);
	vfprintf(logfile.fp, fmt, ap);
	va_end(ap);
	fprintf(logfile.fp, "\r\n");
