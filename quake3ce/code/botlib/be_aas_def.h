...
{
	bvec3_t phys_gravitydirection;
	bfixed phys_friction;
	bfixed phys_stopspeed;
	bfixed phys_gravity;
	bfixed phys_waterfriction;
	bfixed phys_watergravity;
	bfixed phys_maxvelocity;
	bfixed phys_maxwalkvelocity;
	bfixed phys_maxcrouchvelocity;
	bfixed phys_maxswimvelocity;
	bfixed phys_walkaccelerate;
	bfixed phys_airaccelerate;
	bfixed phys_swimaccelerate;
	bfixed phys_maxstep;
	bfixed phys_maxsteepness;
	bfixed phys_maxwaterjump;
	bfixed phys_maxbarrier;
	bfixed phys_jumpvel;
	bfixed phys_falldelta5;
	bfixed phys_falldelta10;
	bfixed rs_waterjump;
	bfixed rs_teleport;
	bfixed rs_barrierjump;
	bfixed rs_startcrouch;
	bfixed rs_startgrapple;
	bfixed rs_startwalkoffledge;
	bfixed rs_startjump;
	bfixed rs_rocketjump;
	bfixed rs_bfgjump;
	bfixed rs_jumppad;
	bfixed rs_aircontrolledjumppad;
	bfixed rs_funcbob;
	bfixed rs_startelevator;
	bfixed rs_falldamage5;
	bfixed rs_falldamage10;
	bfixed rs_maxfallheight;
	bfixed rs_maxjumpfallheight;
} aas_settings_t;
...
typedef struct aas_routingcache_s
{
	...
	gfixed time;									//last time accessed or updated
	int size;									//size of the routing cache
	int cluster;								//cluster the cache is for
	int areanum;								//area the cache is created for
	bvec3_t origin;								//origin within the area
	gfixed starttraveltime;						//travel time to start with
...
typedef struct aas_routingupdate_s
{
	...
	bvec3_t start;								//start point the area was entered
