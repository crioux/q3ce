...
static void Demos_MenuInit( void ) {
	...
	s_demos.banner.string			= strdup("DEMOS");
	...
	Com_sprintf(extension, sizeof(extension), "dm_%d", FIXED_TO_INT(_UI_trap_Cvar_VariableValue( "protocol" )) );
	s_demos.list.numitems			= _UI_trap_FS_GetFileList( "demos", extension, s_demos.names, NAMEBUFSIZE );
...
void Demos_Cache( void ) {
	...
	_UI_trap_R_RegisterShaderNoMip( ART_GO0 );
	_UI_trap_R_RegisterShaderNoMip( ART_GO1 );
	_UI_trap_R_RegisterShaderNoMip( ART_FRAMEL );
	_UI_trap_R_RegisterShaderNoMip( ART_FRAMER );
	_UI_trap_R_RegisterShaderNoMip( ART_ARROWS );
	_UI_trap_R_RegisterShaderNoMip( ART_ARROWLEFT );
	_UI_trap_R_RegisterShaderNoMip( ART_ARROWRIGHT );
}
